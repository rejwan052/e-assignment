(function($) {
	...
	var myAvatarDropzone = new Dropzone("div#avatar-upload", {
		url : "/upload",
	...
	myAvatarDropzone.emit("addedfile", mockFile);
	// And optionally show the thumbnail of the file:
	myAvatarDropzone.emit("thumbnail", mockFile, myAvatarDropzone.createThumbnailFromUrl(mockFile, mockFile.url));
	// Add file to list of files
	myAvatarDropzone.files.push(mockFile);
	// Call complete to remove the loader
	myAvatarDropzone.emit("complete", mockFile);*/
